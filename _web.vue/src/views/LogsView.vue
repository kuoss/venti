    ...
    <div class="flex-1 py-4 px-4">
      ...
      <div class="break-all">
        <table class="w-full bg-slate-300">
          <tr>
            <td class="px-2" v-if="lastExecuted">
              {{ lastExecuted.range[0] }} - {{ lastExecuted.range[1] }}
            </td>
        ...
        <div v-else-if="result && result.length < 1">
          <div class="rounded bg-slate-200 text-center py-20">
            empty query result
          </div>
        </div>
        <div v-else-if="result">
          <div
            ref="logs"
            class="font-mono overflow-y-auto border bg-white max-h-[80vh]"
          >
          ...
          <div v-for="ns in namespaces">
            <div class="cursor-pointer" @click="ns.isExpanded = !ns.isExpanded">
              <i
                class="mdi"
                :class="[
                  ns.isExpanded ? 'mdi-chevron-down' : 'mdi-chevron-right',
                ]"
              ></i>
              {{ ns.name }}
            </div>
            <div v-if="ns.isExpanded" v-for="w in ns.workloads">
              <div
                ...
                @click="w.isExpanded = !w.isExpanded"
              >
                <i
                  class="mdi"
                  :class="[
                    w.isExpanded ? 'mdi-chevron-down' : 'mdi-chevron-right',
                  ]"
                ></i>
