...
func TestAlertRuleFiles(t *testing.T) {
	...
	want := `[{"kind":"AlertRuleFile","commonLabels":{"rulefile":"sample-v3","severity":"silence"},"datasourceSelector":{"system":"","type":"prometheus"},"groups":[{"name":"sample","rules":[{"alert":"S00-AlwaysOn","expr":"vector(1234)","for":"0s","labels":{"hello":"world"},"annotations":{"summary":"AlwaysOn value={{ $value }}"}},{"alert":"S01-Monday","expr":"day_of_week() == 1 and hour() \u003c 2","for":"0s","annotations":{"summary":"Monday"}},{"alert":"S02-NewNamespace","expr":"time() - kube_namespace_created \u003c 120","for":"0s","annotations":{"summary":"labels={{ $labels }} namespace={{ $labels.namespace }} value={{ $value }}"}}]}]}]`
