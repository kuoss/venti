        ...
        <tbody v-for="(f, i) in alertRuleFiles">
          ...
          <template v-for="g in f.groups">
            ...
            <tr class="border-b" v-for="r in g.rules">
              <td class="p-1 pl-9">
                <div class="rounded w-24 text-center bg-red-300" v-if="r.state == 'firing'">firing</div>
                <div class="rounded w-24 text-center bg-yellow-300" v-else-if="r.state == 'pending'">pending</div>
