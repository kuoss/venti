    ...
    <form class="bg-slate-200 shadow-md rounded px-8 pt-6 pb-8 mb-4" @submit.prevent="login">
      <div class="mb-4">
        ...
        <input id="username" type="text" placeholder="Username" autocomplete="username"
          ...
          :class="{ 'border-red-500': errorData.error }" v-model="username" :disabled="loading" />
      </div>
      <div class="mb-6">
        ...
        <input id="password" type="password" placeholder="******************" autocomplete="current-password"
          ...
          :class="[errorData.error? 'border-red-500' : 'border-slate-400']" v-model="password" :disabled="loading" />
